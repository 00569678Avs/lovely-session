            ...
            Malvin.ev.on("connection.update", async (s) => {
                ...
                if (connection === "open") {
                    ...
                    const sid = megaUrl.includes("https://mega.nz/file/")
                        ? 'LOVELY-MD~' + megaUrl.split("https://mega.nz/file/")[1]
                        : 'Error: Invalid URL';
...
💡 *Whats Next?* 
1️⃣ Explore all the cool features of LOVELY-MD.
...
⭐ *Show Some Love!* Give us a ⭐ on GitHub and support the developer of: 👉 [00569678Avs GitHub Repo](https://github.com/00569678Avs)  

🚀 _Thanks for choosing LOVELY-MD — Let the automation begin!_ ✨`;
